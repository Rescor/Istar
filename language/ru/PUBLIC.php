...
$LNG['loginWelcome']                = 'Добро пожаловать в 2Moons (сервер %s)';
$LNG['loginServerDesc']             = '2Moons - это стратегический космический симулятор в реальном времени. Сражайтесь с другими игроками, чтобы стать лучшим.';
